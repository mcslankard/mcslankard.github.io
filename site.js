const artifacts = [
  {
    ...
    description: [
      "McDonald’s used this yellow polystyrene container between 1975 and 1990 to hold and advertise the Quarter Pounder with cheese. The package displays the McDonald’s logo and says that the burger contained a quarter pound of beef before cooking (McDonald’s Corporation, “Quarter Pounder”).",
      "The Smithsonian explains that the Quarter Pounder was introduced nationally in 1973 for customers who wanted a larger hamburger patty than the standard McDonald’s hamburger (McDonald’s Corporation, “Quarter Pounder”)."
    ],
    analysis: [
      ...
      "This container connects to Nielsen and Popkin’s research showing that hamburger portions grew during this same general period. The numbers show that portion growth really happened, while the package shows how McDonald’s presented that growth to customers (Nielsen and Popkin 450–52)."
    ],
  ...
  },
  {
    ...
    description: [
      "This pink polystyrene container held and advertised the Big Mac. The package displays the Big Mac name and McDonald’s logo. The burger used two beef patties and an extra middle bun, giving it the stacked appearance that people still recognize (McDonald’s Corporation, “Big Mac”).",
      "The Big Mac was introduced nationally in 1968 and was originally created to compete with a similar sandwich sold by Big Boy (McDonald’s Corporation, “Big Mac”)."
    ],
    analysis: [
      ...
      "Placing these containers beside each other shows that McDonald’s offered more than one larger burger. When customers repeatedly saw different large options with their own names and packaging, bigger meals could begin to feel like normal menu choices (Nielsen and Popkin 450–52)."
    ],
  ...
  },
  {
    ...
    description: [
      "McDonald’s created this double polystyrene container for the McD.L.T. One side held the quarter-pound beef patty and bottom bun so they stayed hot. The other side kept the lettuce, tomato, cheese, pickles, sauce, and top bun cold (McDonald’s Corporation, “McD.L.T.”).",
      "The package was much wider than a normal burger box because it separated the hot and cold parts. The Smithsonian notes that the product was later removed and that fast-food chains moved away from polystyrene packaging after environmental controversy (McDonald’s Corporation, “McD.L.T.”)."
    ],
    analysis: [
...
function header(active) {
  const links = [["home","Home","/"], ...artifacts.map(a => [a.key,a.nav,a.path]), ["conclusion","Conclusion","/conclusion/"], ["works","Works Cited","/works-cited/"]];
...
function footer() { return `<footer><div class="shell"><span>Mary Slankard · English 102 · July 2026</span><a href="/works-cited/">View all sources →</a><small class="ai-note">ChatGPT was used in the editing of this page’s content.</small></div></footer>`; }
...
function works() {
  return `${header('works')}<main><section class="page-head"><div class="shell"><p class="eyebrow">Research behind the exhibit</p><h1>Works Cited</h1><p>Peer-reviewed research and archival objects provide the evidence behind this exhibit.</p></div></section><section class="citations shell"><h2>Works Cited</h2>
  <p>McDonald’s Corporation. “McDonald’s Big Mac Clam Shell Container.” 1975–1990. <em>National Museum of American History, Smithsonian Institution</em>, <a href="https://americanhistory.si.edu/collections/object/nmah_1200817">americanhistory.si.edu/collections/object/nmah_1200817</a>. Accessed 24 July 2026.</p>
  <p>McDonald’s Corporation. “McDonald’s McD.L.T. Double Clam Shell Container.” Circa 1980s. <em>National Museum of American History, Smithsonian Institution</em>, <a href="https://americanhistory.si.edu/collections/object/nmah_1200811">americanhistory.si.edu/collections/object/nmah_1200811</a>. Accessed 24 July 2026.</p>
  <p>McDonald’s Corporation. “McDonald’s Quarter Pounder Clam Shell Container.” 1975–1990. <em>National Museum of American History, Smithsonian Institution</em>, <a href="https://americanhistory.si.edu/collections/object/nmah_1200814">americanhistory.si.edu/collections/object/nmah_1200814</a>. Accessed 24 July 2026.</p>
  ...
  <div class="ai-statement"><h2>AI Use Statement</h2><p>ChatGPT was used in the composition of this website as part of the editing process. It was used for stylistic suggestions, identifying places where citations were needed, and finding revision opportunities. The final choices and revisions were reviewed by the author.</p></div></section></main>${footer()}`;
}
...
function conclusion() {
  return `${header('conclusion')}<main><section class="page-head"><div class="shell"><p class="eyebrow">Conclusion</p><h1>When Bigger Became Familiar</h1><p>The three containers show that portion growth was also a change in how food was presented.</p></div></section><section class="conclusion shell"><p>The Quarter Pounder, Big Mac, and McD.L.T. each made a larger burger feel like its own special product. Their names, colors, and packaging did more than hold food. They helped customers recognize size, convenience, and value as reasons to choose one meal over another. Looking at the containers together shows that this shift was repeated across different products instead of happening through one menu item.</p><p>The research adds another part of the story. Portion sizes measurably increased, larger servings encouraged people to eat more, and many oversized items remained available into the twenty-first century (Nielsen and Popkin 450–52; Rolls et al. 1209–11; Young and Nestle 2223–25). The artifacts cannot prove that packaging alone changed every customer’s habits, but they show how the industry made larger choices visible and memorable.</p><p>Overall, bigger did not become normal overnight. It became normal through repetition. As customers continued seeing large portions presented as exciting and worth the money, those portions became familiar enough to feel standard. The meaning of a “normal” serving changed along with the products placed in front of them.</p></section></main>${footer()}`;
}

const route = location.pathname.replace(/\/+$/, '') || '/';
let html = route === '/' ? home() : route === '/works-cited' ? works() : route === '/about' ? about() : route === '/conclusion' ? conclusion() : null;
