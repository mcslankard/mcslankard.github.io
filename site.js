...
function footer(showAi = true) { return `<footer><div class="shell"><span>Mary Slankard · English 102 · July 2026</span><a href="/works-cited/">View all sources →</a>${showAi ? '<small class="ai-note">ChatGPT was used in the editing of this page’s content.</small>' : ''}</div></footer>`; }
...
function works() {
  ...
  <p>Young, Lisa R., and Marion Nestle. “Portion Sizes of Ultra-Processed Foods in the United States, 2002 to 2021.” <em>American Journal of Public Health</em>, vol. 111, no. 12, 2021, pp. 2223–2226. <a href="https://doi.org/10.2105/AJPH.2021.306513">https://doi.org/10.2105/AJPH.2021.306513</a>.</p></section></main>${footer(false)}`;
}
